...
- **Conexión SQL:** sqlAlchemy, pymysql
- **Visualización:** streamlit, plotly.express
- **Utilidades:** os, json, logging, datetime
...
- 🎥 **Video explicativo:** [Ver en YouTube](https://youtu.be/UN0gJBJAJMc)
- **Ejecución:**
...
**Desarrollado por:** [Boris Guevara](https://github.com/bguevara)
